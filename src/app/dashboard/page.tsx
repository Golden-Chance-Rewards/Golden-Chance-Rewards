...
// ── Inline SVG Icons (replaces iconify-icon web component) ──────────────────
const Icons = {
              ...
              <div style={{ background: 'var(--gc-card)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 20, padding: 22, position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 22 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 5, background: 'rgba(255,60,60,0.1)', border: '1px solid rgba(255,60,60,0.2)', borderRadius: 999, padding: '4px 10px' }}>
                    <span style={{ width: 6, height: 6, borderRadius: '50%', background: 'var(--gc-danger)', display: 'inline-block' }} />
              ...
              <div style={{ background: 'var(--gc-card)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 20, padding: 22 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                  {[
                    ...
                    <div key={rank} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '8px 6px', borderRadius: 10, transition: 'background .15s' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 12px', borderRadius: 12, background: 'rgba(245,197,24,0.04)', border: '1px solid rgba(245,197,24,0.2)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                        <div style={{ position: 'relative', width: 32, height: 32, borderRadius: '50%', border: '2px solid rgba(245,197,24,0.3)', overflow: 'hidden' }}>
                ...
                <a href="#" style={{ display: 'block', textAlign: 'center', marginTop: 18, fontSize: 11, fontWeight: 700, color: '#444', letterSpacing: 2, textDecoration: 'none', textTransform: 'uppercase', transition: 'color .15s' }}>
